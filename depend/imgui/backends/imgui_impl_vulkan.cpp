...
#else
        IM_ASSERT(0 && "Can't use dynamic rendering when neither VK_VERSION_1_3 0r VK_KHR_dynamic_rendering is defined.");
#endif
    }
...
void ImGui_ImplVulkan_UpdateTexture(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout, VkDescriptorSet set)
{
    ImGui_ImplVulkan_Data* bd = ImGui_ImplVulkan_GetBackendData();
    ImGui_ImplVulkan_InitInfo* v = &bd->VulkanInitInfo;
